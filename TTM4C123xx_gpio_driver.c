...
void GPIO_Init(GPIO_Handle_t *pGPIOHandle)
{
    ...
    if(pGPIOHandle->PinConfig.PinAltFuncType.Enable)
    {
      ...
      if(pGPIOHandle->PinConfig.PinAltFuncType.PeriControl > 0)
        pGPIOHandle->pGPIO_Base_Address->PCTL |= (uint32_t)(pGPIOHandle->PinConfig.PinAltFuncType.PeriControl << (4 * pGPIOHandle->PinConfig.PinNumber));
